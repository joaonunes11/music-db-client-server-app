...
def utilizadores(id=None):
    ...
    if request.method == 'GET':
        ...
        # SHOW USERS
        elif request.url == 'http://localhost:5000/utilizadores/all':
            users = query_db(
    ...
    # ADD
        ...
        # ADD USER RATE
        elif request.url == 'http://localhost:5000/utilizadores/rate':
            data = json.loads(request.data)
            rate_id = query_db(
...
def bandas(id=None):
    ...
    if request.method == 'GET':
        ...
        # SHOW BANDA
        if request.url == 'http://localhost:5000/bandas/' + str(id):
            banda = query_db(
        ...
        # SHOW BANDAS
        elif request.url == 'http://localhost:5000/bandas/all':
            bandas = query_db(
                "SELECT * FROM bandas")
    ...
    # REMOVE
        ...
        # REMOVE BANDAS
        if request.url == 'http://localhost:5000/bandas/all':
            bandas = query_db(
                "SELECT * FROM bandas")
    ...
    # ADD
        ...
        # ADD BAND
        if request.url == 'http://localhost:5000/bandas':
            data = json.loads(request.data)
...
def albuns(id=None):
    if request.method == 'POST':
        ...
        # ADD ALBUM
        if request.url == 'http://localhost:5000/albuns':
            data = json.loads(request.data)
    ...
    # SHOW
        ...
        # SHOW ALBUM
        if request.url == 'http://localhost:5000/albuns/' + str(id):
            album = query_db(
        ...
        # SHOW ALBUNS
        elif request.url == 'http://localhost:5000/albuns/all':
            albuns = query_db(
                "SELECT * FROM albuns")
        ...
        # SHOW ALBUNS BANDA
        elif request.url == 'http://localhost:5000/albuns/banda/' + str(id):
            albuns = query_db(
        ...
        elif request.url == 'http://localhost:5000/albuns/utilizador/' + str(id):
            albuns = query_db(
        ...
        # SHOW ALBUNS RATE
        elif request.url == 'http://localhost:500/albuns/rate/' + str(id):
            albuns = query_db(
    ...
    # REMOVE
        ...
        # REMOVE ALBUNS RATE
        elif request.url == 'http://localhost:5000/albuns/rate/' + str(id):
            albuns = query_db(
                "SELECT * FROM albuns WHERE id in(SELECT id_album FROM listas_albuns WHERE id_rate=?)", [int(id)])

            if len(albuns) > 0:
                delete = query_db(
                    "DELETE FROM albuns WHERE id in(SELECT id_album FROM listas_albuns WHERE id_rate=?)", [int(id)])
                r = make_response(json.dumps("removed!"))
                r.status_code = 200
            else:
                r = make_response(json.dumps("not found!"))
